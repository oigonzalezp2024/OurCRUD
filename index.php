...
<head>
    ...
    <link rel="stylesheet" href="librerias/css/bootstrap4.min.css">
...
<body>
    <nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
        ...
        <form style="margin-left:20px; margin-right:5px;" action="laboratorio/crear_proyecto.php">
            <select style="font-size:22px; margin:4px;" class="selector text-info" name="base">
    ...
    <div class="container">
        ...
        <div class="col-sm-4" style="float:left;">
            ...
            <p><b>OurCRUD</b> Mediante el botón <b>create database</b> lo llevará a un panel de control donde podrá documentar bases de datos y generar a partir de ese configuración la creación y actualización de su estructura, luego podrá generar automaticamente el proyecto CRUD para todas sus tablas.</p>
            <b>Software desarrollado por:</b><br /> Óscar Iván González Peña,
            <br>Tecnólogo en Análisis y Desarrollo de Sistemas
            de Información desde 2020 ADSI-SENA.<br /><br />
            <b>Agradecimiento especial al ingeniero:</b><br> César Alfonso Bolado Silva.<br /><br>
            <b>Y al empresario </b><br> John Hoyos<br />
            <br /><br />
        ...
        <div class="col-md-6"
            style="font-size: 14px;
                 line-height: 1.5;
                 color: #24292e;
                 box-sizing: border-box; float:right;"><br />
            <hr />
            <p class="text-small text-gray mb-0 lh-condensed-ultra">
                OscarGonzalez1987/OurCRUD is licensed under the
            </p>
        ...
        <div class="col-md-4"
            style="font-size: 14px;
                 line-height: 1.5;
                 color: #24292e;
                 box-sizing: border-box; float:right; text-align:right"><br />
            <hr />
