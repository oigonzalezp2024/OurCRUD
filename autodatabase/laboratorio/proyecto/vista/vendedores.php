...
<html>
	...
	?>
	<script src="../controlador/funciones_vendedores.js"></script>
    </head>
    <body id="body">
	<?php
	include 'header.php';
	...
	<div class="modal fade" id="modalNuevo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<div class="modal-content">
			...
			<input type="number" id="id_vendedor" class="form-control input-sm" required="">
			<label>nombre</label>
	...
	<div class="modal fade" id="modalEdicion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<div class="modal-content">
		    ...
		    <div class="modal-body">
			<input type="number" hidden="" id="id_vendedoru">
			<label>nombre</label>
	...
	<script type="text/javascript">
		...
		$('#tabla').load('componentes/vista_vendedores.php');
	    });
	</script>
	<script type="text/javascript">
	    $(document).ready(function () {
		$('#guardarnuevo').click(function () {
		    ...
		    celular = $('#celular').val();
		    agregardatos(id_vendedor, nombre, apellido, direccion, celular);
		});
