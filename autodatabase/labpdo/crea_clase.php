...
function crea_clase($base, $tabla)
{
    ...
    archivo_clase($tabla, pag_web_clase($base, $tabla, $campo, $tipo_dato, $llave, $llave_tipo_dato, $modi, $modi_tipo_dato, $tomad));
}
...
function pag_web_clase($base, $tabla, $campo, $tipo_dato, $llave, $llave_tipo_dato, $modi, $modi_tipo_dato, $tomad)
{
    $head = head_clase($tabla);
    $body = body_clase($base, $tabla, $campo, $tipo_dato, $llave, $llave_tipo_dato, $modi, $modi_tipo_dato, $tomad);
...
function body_clase($base, $tabla, $campo, $tipo_dato, $llave, $llave_tipo_dato, $modi, $modi_tipo_dato, $tomad)
{
    $modal_insertar = modal_insertar($base, $campo, $tipo_dato);
    $modal_edicion = modal_edicion($base, $llave, $llave_tipo_dato, $modi, $modi_tipo_dato);
...
function modal_insertar($base, $campo, $tipo_dato)
{
    $cuerpo_modal_insertar = cuerpo_modal_insertar($base, $campo, $tipo_dato);
...
function cuerpo_modal_insertar($base, $campo, $tipo_dato)
{
...
function modal_edicion($base, $llave, $llave_tipo_dato, $modi, $modi_tipo_dato)
{
    $cuerpo_modal_edicion = cuerpo_modal_edicion($base, $llave, $llave_tipo_dato, $modi, $modi_tipo_dato);
...
function cuerpo_modal_edicion($base, $llave, $llave_tipo_dato, $modi, $modi_tipo_dato)
{
